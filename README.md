...
The material was initially created as a collaboration for a lecture series with the SEG. Because it is intended for use in live lectures, some slides are left for completion or further explanation. The plan is to extend the repository with additional learning materials and more advanced topics, and contributions are welcome.
...
### Usage and sharing
These materials are intended only for personal learning and should not be used for teaching or financial purposes. Please make sure to cite the repository when sharing. This work is licensed under a Creative Commons Attribution-NonCommercial 4.0 International License.
